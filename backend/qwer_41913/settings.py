"""
Django settings for qwer_41913 project.
...
WSGI_APPLICATION = 'qwer_41913.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qwer_41913 API",
    "DESCRIPTION": "API documentation for qwer_41913 App",
    "VERSION": "v1",
}
